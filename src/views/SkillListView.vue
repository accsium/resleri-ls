  ...
  <div class="skf-bar">
    <div class="skf-row">
      <div class="skf-group">
        ...
        ><IconDisplay type="attribute" :id="id" :scale="1" :size="0" /></button>
      </div>
  ...
  >
    ...
    <template #cell-avatar="{ row }">
      <div class="ls-avatar-cell">
        <AvatarDisplay v-if="charIndexMap[row.char_id]" :indexEntry="charIndexMap[row.char_id]" :scale="3" :size="0" :image-s="row.image_s" />
      </div>
    </template>
